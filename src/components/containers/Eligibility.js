...
const Eligibility = () => (
  <div className="background-white flex">
    <div className="info-segment-content vertical-split">
      ...
      encouraged to apply. A limited number of scholarships will be awarded for the 2025-26 academic year.
      </p>
  ...
  with a high school diploma or GED (as of fall 2025).</li>
