...
const Eligibility = () => (
  <div className="background-white flex">
    <div className="info-segment-content vertical-split">
      ...
      encouraged to apply. A limited number of scholarships will be awarded for the 2020-21 academic year.
      </p>
    </div>
  ...
  with a high school diploma or GED (as of fall 2020).</li>
          <li>Must be able to verify enrollment at the beginning of the 2020 fall term.</li>
