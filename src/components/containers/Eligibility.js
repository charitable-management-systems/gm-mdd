...
const Eligibility = () => (
  <div className="background-white flex">
    <div className="info-segment-content vertical-split">
      ...
      encouraged to apply. A limited number of scholarships will be awarded for the 2024-25 academic year.
      </p>
      <p>The application deadline is April 15, 2024.</p>
    </div>
  ...
  with a high school diploma or GED (as of fall 2024).</li>
          <li>Must be able to verify enrollment at the beginning of the 2024 fall term.</li>
